...
class $48c7f21169d49005$export$b7173f2d596cb720 extends (0, $3KHBw.ROM) {
    constructor(){
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($hMNzR))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($hMNzR))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($hMNzR))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($hMNzR))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($hMNzR))).text;
...
parcelRegister("hMNzR", function(module, exports) {
...
//# sourceMappingURL=esp8266.a4e6c585.js.map
