...
/*********
  Rui Santos
  Complete project details at https://randomnerdtutorials.com/esp32-esp8266-rgb-led-strip-web-server/  
*********/
...
void setup() {
 ...
 if (!MDNS.begin("rgb")) { // Start the mDNS responder for rgb.local
